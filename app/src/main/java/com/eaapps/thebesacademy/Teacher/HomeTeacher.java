...
public class HomeTeacher extends AppCompatActivity {
    ...
    String[] items = {"Communiction", "Upload lecture", "My File", "Attendance List"};
    int icon[] = {R.drawable.communication_icon64, R.drawable.cloud_upload64,
            R.drawable.folder64, R.drawable.attendance_icon64};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileRetrieveData.RetrieveSingleTimes(Profile.class, ref, objects -> {
